...
export const RESUME_TEMPLATES: Template[] = [
  {
    ...
    description: "Timeless design perfect for traditional corporate environments and executive positions",
    category: "classic",
    requiresPhoto: false,
    ...
    features: ["Traditional layout", "Corporate-friendly", "ATS-optimized", "Executive styling"],
  },
  {
    id: "modern",
