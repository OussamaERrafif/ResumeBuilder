                    ...
                    <div className="flex gap-2 justify-start min-w-max">
                        {categories.map((category) => (
                            <Button
                                ...
                                size="sm"
                                className={`rounded-full transition-all duration-200 whitespace-nowrap ${selectedCategory === category.id
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                        <AnimatePresence mode="popLayout">
                            {filteredTemplates.map((template, index) => (
                                ...
                                >
                                    <Card
                                        className={`cursor-pointer transition-all duration-300 bg-card border-border rounded-2xl overflow-hidden group ${selectedTemplate === template.id
